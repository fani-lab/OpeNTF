...
settings = {
    ...
    "data": {
        ...
        "filters": {
            ...
            "uspt": {
                # Patent filing/publication year
                "min_year": None,  # None means no filtering
                "max_year": None,  # None means no filtering
            },
            "imdb": {
                ...
                "title_type": [
                    "movie"
                ],  # List of title types to include (empty means all). Example: ['movie', 'tvSeries']
            },
            "gith": {
                # repository creation year
                "min_year": None,  # None means no filtering
                "max_year": None,  # None means no filtering
                "ntop_skills": 30,  # None means no filtering, enter a number to include only top n skills
            },
        },
        "processing": {
