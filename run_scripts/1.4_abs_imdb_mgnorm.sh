...
models=("transformer-abs_mgnorm01" "transformer-abs_mgnorm02" "transformer-abs_mgnorm03" "transformer-abs_mgnorm04" "transformer-abs_mgnorm06" "transformer-abs_mgnorm07" "transformer-abs_mgnorm08" "transformer-abs_mgnorm09" "transformer-abs_mgnorm10")
datasets=("imdb")
gpus="6,7"
...
# run another .sh file
echo ""
echo "Running the next .sh file: 1.4_abs_imdb_lsmoothing.sh"
./1.4_abs_imdb_lsmoothing.sh