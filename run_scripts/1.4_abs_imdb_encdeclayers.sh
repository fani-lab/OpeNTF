...
# from edl02 to edl32, increments of 2
models=("transformer-abs_edl02" "transformer-abs_edl06" "transformer-abs_edl08" "transformer-abs_edl10" "transformer-abs_edl12" "transformer-abs_edl14" "transformer-abs_edl16" "transformer-abs_edl18" "transformer-abs_edl20" "transformer-abs_edl22" "transformer-abs_edl24" "transformer-abs_edl26" "transformer-abs_edl28" "transformer-abs_edl30" "transformer-abs_edl32")
datasets=("imdb")
gpus="6,7"
