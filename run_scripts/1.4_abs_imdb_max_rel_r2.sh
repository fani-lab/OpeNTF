...
# 22 to 32
models=("transformer-abs_max_rel22" "transformer-abs_max_rel24" "transformer-abs_max_rel26" "transformer-abs_max_rel28" "transformer-abs_max_rel30" "transformer-abs_max_rel32")
datasets=("imdb")
gpus="6,7"
