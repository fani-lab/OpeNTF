...
##docker run {--gpus all} --rm -v ./data:/app/data:ro -v ./output:/app/output ghcr.io/fani-lab/opentf/dblp:main 2>&1 | tee prep.teamsvecs.log
...
##docker build -t ghcr.io/fani-lab/opentf/dblp:main .
##docker run --rm -v ./data:/app/data:ro -v ./output:/app/output ghcr.io/fani-lab/opentf/dblp:main 2>&1 | tee prep.d2v.skill.log
...
##docker run {--gpus all} --rm -v ./data:/app/data:ro -v ./output:/app/output ghcr.io/fani-lab/opentf/imdb:main 2>&1 | tee prep.teamsvecs.log
# Generate d2v embeddings
...
##docker build -t ghcr.io/fani-lab/opentf/imdb:main .
##docker run --rm -v ./data:/app/data:ro -v ./output:/app/output ghcr.io/fani-lab/opentf/imdb:main 2>&1 | tee prep.d2v.skill.log
...
##docker run {--gpus all} --rm -v ./data:/app/data:ro -v ./output:/app/output ghcr.io/fani-lab/opentf/gith:main 2>&1 | tee prep.teamsvecs.log
# Generate d2v embeddings
...
##docker build -t ghcr.io/fani-lab/opentf/gith:main .
##docker run --rm -v ./data:/app/data:ro -v ./output:/app/output ghcr.io/fani-lab/opentf/gith:main 2>&1 | tee prep.d2v.skill.log
...
##docker run {--gpus all} --rm -v ./data:/app/data:ro -v ./output:/app/output ghcr.io/fani-lab/opentf/uspt:main 2>&1 | tee prep.teamsvecs.log
# Generate d2v embeddings
...
##docker build -t ghcr.io/fani-lab/opentf/uspt:main .
##docker run --rm -v ./data:/app/data:ro -v ./output:/app/output ghcr.io/fani-lab/opentf/uspt:main 2>&1 | tee prep.d2v.skill.log

#========================================================
#docker build -t ghcr.io/fani-lab/opentf/{###}:main .
#docker run {--gpus all} --rm -v ./data:/app/data:ro -v ./output:/app/output ghcr.io/fani-lab/opentf/{###}:main 2>&1 | tee {###}.log
