...
if __name__ == '__main__':
    skill_vecs, member_vecs, i2m, m2i, i2s, s2i, i2t, t2i, len_teams = Publication.generate_sparse_vectors(data_path=f'../data/raw/{output}.json', output=f'../data/preprocessed/{output}', topn=None)
