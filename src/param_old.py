...
settings = {
    "model": {
        "baseline": {
            ...
            "nmt": {"base_config": "./mdl/nmt_config.yaml"},
            "nmt_convs2s": {"base_config": "./mdl/nmt_config_convs2s.yaml"},
            "nmt_rnn": {"base_config": "./mdl/nmt_config_rnn.yaml"},
            "nmt_transformer": {"base_config": "./mdl/nmt_config_transformer.yaml"},
            "nmt_transformer_model1": {
                "base_config": "./mdl/nmt_config_transformer_model1.yaml"
            },
            "nmt_transformer_model2": {
                "base_config": "./mdl/nmt_config_transformer_model2.yaml"
            },
            "caser": {},
            "rrn": {"with_zero": True},
            "emb": {
