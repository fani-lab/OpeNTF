    ...
    return (
        <div className="home-content">
                ...
                <div className="section-body justify-paragraph">
                    ...
                    <ul>
                        <li className="justify-paragraph">
                            We target beginner or intermediate researchers, industry technologists and practitioners with a broad interest in user modeling and recommender systems who are willing to have a whole picture of team recommendation techniques.
                        </li>
                        <li className="justify-paragraph">
                            Furthermore, this tutorial targets audiences from the graph neural network (GNN) community for a comprehensive review of subgraph optimization objectives and calls them for further development of
                            effective yet efficient graph neural networks with a special focus on team recommendation.
                        </li>
                        <li className="justify-paragraph">
                            Last, having regard to the unified comparative analysis, this tutorial enables organizations and practitioners to compare different models and pick the most suitable one for their application to form collaborative teams of experts whose success is almost surely guaranteed.
                        </li>
                    </ul>
            ...
            <section id="section-outline"><span id="section-title-outline" className="section-title">Outline</span>
                ...
                <div className="section-body">
                  <span className="d-block w-100 justify-paragraph">
                    As seen in Figure 2, We start our tutorial with a brief introduction to the pioneering graph-based team recommendation algorithms based on a taxonomy of computational methods, as shown in Figure 3,4, then continue to explore the learning-based team recommendation and team refinement methods, focusing on modern methods based on graph neural networks and reinforcement learning.
                  </span>
                </div>
                <div className="section-body justify-paragraph"style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            ...
            <section id="section-searchbased"><span id="section-title-searchbased" className="section-title">Pioneering Techniques </span>
                <div className="section-body justify-paragraph">
                       <span className="d-block w-100 justify-paragraph">
                           ...
                           recommendation were developed in operations research (OR), optimizing objectives using integer linear and/or nonlinear programming (IP). Such work, however, was premised on the mutually independent selection of experts and overlooked the organizational and/or social ties. To bridge the gap, graph-based approaches have been proposed to recommend teams via subgraph optimization where the different aspects of real-world teams are captured like communication cost and geographical proximity. This section of our tutorial provides an overview of the graph-based approaches in team recommendation methods.

                       </span>
                       <div className="topic-item">
                            <ul><li className="justify-paragraph">
                                <span className="fw-bold">Subgraph Optimization Objectives:</span>
                                    &nbsp;In our tutorial, we formalized more than 13 objectives in a unified framework with integrated notations for better readability and fostering conventions in this realm.
                                </li>
                                <li className="justify-paragraph">
                                  <span className="fw-bold">Subgraph Optimization Techniques:</span>
                                    &nbsp;We describe the seminal heuristics that have been followed by the majority of researchers, as well as the groups that optimization techniques can be studied in.
                                </li>
                                <li className="justify-paragraph">
                                    <span className="fw-bold">Evaluation Methodology:</span>
                                    &nbsp;Finally, we lay out the methodologies, benchmark datasets, and quantitative and qualitative metrics that are used to evaluate the performance of the graph-based approaches.
                                </li>
                            </ul>
                       </div>
            ...
            <section id="section-learnbased"><span id="section-title-learnbased" className="section-title">Neural Team Recommendation </span>
                    <div className="section-body">
                        <span className="d-block w-100 justify-paragraph">
                          We will then explain the learning-based methods, which has been mostly based on neural models. Learning-based methods bring efficiency while enhancing efficacy due to the inherently iterative and online learning procedure, and can address the limitations of search-based solutions with respect to scalability, as well as dynamic expert networks (<a target="_blank" href="https://dl.acm.org/doi/10.1145/3589762">Rad, R. et al., 2023</a>;{" "}<a target="_blank" href="https://dl.acm.org/doi/10.1145/3340531.3412140">Rad, R.H., et al., 2020</a>). We will lay out the details of different neural architecture and their applications in team recommendation, from autoencoder to graph neural networks.
                        </span>
                        <div className="topic-item">
                            <ul>
                                ...
                                <li className="justify-paragraph">
                                    ...
                                    &nbsp;In our tutorial, we will discuss the details of different negative sampling heuristics to draw virtually unsuccessful teams and streaming training strategy that put a chronological order on teams during training.
                                </li>
                                <div className="section-topic justify-paragraph"style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                ...
                <div className="section-body justify-paragraph">
                        <div className="topic-item">
                            Reinforcement learning with neural policy estimators has been increasingly employed to learn the dynamics of real-world teams for structural modifications or team member replacements in order to maintain or even improve team effectiveness by modeling the problem in a multi-agent setting where a group of agents synchronize their actions in a decentralized manner within a shared environment to achieve a common goal. The task cannot be completed by any individual agent alone but in a team of agents, and each agent must make a decision regarding which team to join.
                        </div>
            ...
            <section id="section-challeng"><span id="section-title-challeng" className="section-title">Challenges and New Perspectives </span>
                <div className="section-body">
                    <div className="topic-item">
                            ...
                            <span className="d-block w-100 justify-paragraph">
                                The primary focus of existing team recommendation methods is the maximization of the success rate for the recommended teams, largely ignoring diversity in the recommended users. In our tutorial, we introduce notions of fairness and in-process, e.g.,
                                <a target="_blank" href="https://github.com/fani-lab/OpeNTF/tree/vivaFemme-bias24"> (vivaFemme)</a> and
                                <a target="_blank" href="https://github.com/fani-lab/OpeNTF/tree/cl-wsdm25"> debiasing learning curricula</a>, and post-processing reranking
                                <a target="_blank" href="https://github.com/fani-lab/Adila"> (Adila) </a> refinements to reassure the desired fair outcome and explore the synergistic trade-offs between notions of fairness and success rate for the proposed solutions.
                              </span>
                        ...
                        <div className="topic-item">
                            ...
                            <span className="d-block w-100 justify-paragraph">
                                In real-world team recommendation scenarios, balancing multiple, often conflicting objectives (e.g., team effectiveness and experts' workload distribution) requires a training process guided by a loss function that explicitly accounts for multiple objectives. However, existing neural team recommendation approaches, which commonly frame the problem as a classification or link prediction task, aim to maximize the coverage of the required skills and mainly rely on standard loss functions such as cross-entropy, and designing a task-aware loss function is overlooked.
                              </span>
                        </div>
                        <div className="topic-item">
                            <span className="fw-bold text-uppercase h6">Reading List</span>
                ...
                <div className="section-body">
                        <div className="topic-item">
                            In this section, we highlight the practical significance of team recommendation by explaining its seemingly unrelated yet highly valuable applications in education, research, and healthcare, in addition to its common use cases.
                            <span className="d-block w-100 justify-paragraph">
                                <ul>
                                  <li><b> Group Learning: </b>
                                    Team recommendation finds immediate application in group-based learning environments. In online classes, where physical presence and interaction are absent, team recommendation connects students to share ideas and build relationships. This not only enhances their social skills but also combats the isolation that can sometimes accompany remote learning. Via working in teams, students are exposed to varying viewpoints, backgrounds, and problem-solving approaches.
                                  </li>
                                  <li><b> Reviewer Assignment: </b>
                                    Another immediate application of team recommendation is in peer-review assignments where a group of reviewers are paired with manuscripts within the reviewers' expertise for high-quality reviews while managing conflicts of interests. Like team recommendation, herein, research topics (skills) and reviewers (experts) are mapped into a latent space and, given a manuscript about a subset of research topics, team recommendation aims to recommend reviewers with top-k closest vectors to the vectors of the research.
                                  </li>
                                  <li><b> Palliative Care: </b>
                                    Another application of team recommendation is in healthcare, which assigns a team of caregivers to patients who seek help for their daily activities due to disease or disorders. The challenge lies in optimally assigning care providers in teams to address patients' needs while considering factors such as communication, distance, and contract costs.
                                  </li>
                                </ul>
                            </span>
                        </div>
            ...
            <section id="section-handson">
                        ...
                        <span id="section-title-handson" className="section-title">Hands-on OpeNTF </span>
                           <div className="section-body justify-paragraph">
                                    In our tutorial, we introduce publicly available libraries and tools for the task of team recommendation. Notably, we provide hands-on experience with{" "} <a target="_blank" href="https://github.com/fani-lab/OpeNTF"><span className="fw-bold"> {" "}<a target="_blank" href="https://github.com/fani-lab/OpeNTF">OpeNTF</a> </span></a>, an open-source benchmark library for neural models that can efficiently preprocess large-scale datasets, can be easily extended or customized to new neural methods, and is extensible to new datasets from other domains.
                           </div>
            ...
            <section id="section-presenters">
                ...
                <div className="section-body d-flex p-3 direction-row justify-content-between">
                    ...
                    <div className="presenter">
                        ...
                        <span className="text-muted fs-10">Research Fellow<br/>Faculty of Information<br/>University of Toronto</span>
